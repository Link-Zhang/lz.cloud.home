 ...
 */
@Data
public class HistoryHouseIdInput {
    @ApiModelProperty(notes = "HistoryHouseIdFindVO")
    private HistoryHouseIdFindVO historyHouseIdFindVO;
    ...
    private String sortProperties = "historyHouseId";
}
