...
public class StatisticVO {
    ...
    @ApiModelProperty(notes = "房屋平均总价", position = 1, example = "266.96")
    private Double statisticHouseAvgTotalPrice;

    @JsonProperty("avgUnitPrice")
    @ApiModelProperty(notes = "房屋平均单价", position = 2, example = "45834")
    private BigInteger statisticHouseAvgUnitPrice;

    @JsonProperty("saleCount")
    @ApiModelProperty(notes = "在售房屋数量", position = 3, example = "23762")
    private BigInteger statisticHouseSaleCount;

    @JsonProperty("updateTime")
    @ApiModelProperty(notes = "更新时间", position = 4, example = "2020-09-01 23:30:00")
