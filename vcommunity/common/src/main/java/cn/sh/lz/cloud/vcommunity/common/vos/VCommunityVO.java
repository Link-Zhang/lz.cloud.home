...
public class VCommunityVO {
    ...
    @JsonProperty("name")
    @ApiModelProperty(notes = "社区名称", position = 2, example = "晶波坊")
    private String communityName;

    @JsonProperty("houseCount")
    @ApiModelProperty(notes = "房屋数量", position = 3, example = "12")
    private BigInteger communityHouseCount;

    @JsonProperty("avgTotalPrice")
    @ApiModelProperty(notes = "平均总价", position = 4, example = "303")
    private Double communityAvgTotalPrice;

    @JsonProperty("avgUnitPrice")
    @ApiModelProperty(notes = "平均单价", position = 5, example = "48130")
    private Double communityAvgUnitPrice;

    @JsonProperty("maxTotalPrice")
    @ApiModelProperty(notes = "最高总价", position = 6, example = "370")
    private Double communityMaxTotalPrice;

    @JsonProperty("maxStructureArea")
    @ApiModelProperty(notes = "最大建筑面积", position = 7, example = "78.87")
    ...
    @ApiModelProperty(notes = "最低单价", position = 9, example = "44053")
    private Long communityMinUnitPrice;

    @JsonProperty("minTotalPrice")
    @ApiModelProperty(notes = "最低总价", position = 10, example = "228")
    private Double communityMinTotalPrice;

    @JsonProperty("minStructureArea")
    @ApiModelProperty(notes = "最小建筑面积", position = 11, example = "49.15")
    private Double communityMinStructureArea;

    @JsonProperty("minDownPayment")
    @ApiModelProperty(notes = "最低首付", position = 12, example = "80")
    private Long communityMinDownPayment;

    @JsonProperty("maxUnitPrice")
    @ApiModelProperty(notes = "最高单价", position = 13, example = "53711")
