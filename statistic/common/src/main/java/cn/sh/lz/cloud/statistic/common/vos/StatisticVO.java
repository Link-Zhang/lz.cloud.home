...
public class StatisticVO {
    ...
    @ApiModelProperty(notes = "市辖区", position = 1, example = "嘉定")
    private String statisticHouseDistrict;

    @JsonProperty("avgTotalPrice")
    @ApiModelProperty(notes = "房屋平均总价", position = 2, example = "245.58")
    private Double statisticHouseAvgTotalPrice;

    @JsonProperty("avgUnitPrice")
    @ApiModelProperty(notes = "房屋平均单价", position = 3, example = "32316")
    private BigInteger statisticHouseAvgUnitPrice;

    @JsonProperty("saleCount")
    @ApiModelProperty(notes = "在售房屋数量", position = 4, example = "3096")
    private BigInteger statisticHouseSaleCount;

    @JsonProperty("updateTime")
    @ApiModelProperty(notes = "更新时间", position = 5, example = "2019-05-13 22:00:01")
